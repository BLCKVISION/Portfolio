...
function openProject(projectId) {
  ...
  tl.to('#ui-bottom, #thumb-wrapper, #center-line', { opacity: 0, duration: 0.5 })
    ...
    .to('.proj-hero-wrapper', { height: '80vh', duration: 0.8, ease: 'power3.inOut' })
...
function closeProject(e) {
  ...
  document.getElementById('hire-widget').classList.remove('visible');
  ...
  tl.to('.proj-hero-wrapper', { height: '100vh', duration: 0.7, ease: 'power3.inOut' })
    .add(() => {
