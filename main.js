...
(function(){
  ...
  */
  ...
  splitTl
    ...
    .to('.bs-text-wrap',{gap:'clamp(280px,36vw,580px)', duration:1.4, ease:'power2.inOut'}, 0.30)
    .to('.bs-left', {x:'-8vw', duration:1.4, ease:'power2.inOut'}, 0.30)
    .to('.bs-right',{x:'8vw',  duration:1.4, ease:'power2.inOut'}, 0.30)
